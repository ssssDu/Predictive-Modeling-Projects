...
## Question 2
For this question, we decided to use Naive Bayes and Random Forest methods because they are considered as common ways to deal with text mining problems. 
